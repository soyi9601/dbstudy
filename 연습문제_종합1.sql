...
INSERT INTO ORDER_T(ORDER_ID, CUST_ID, BOOK_ID, AMOUNT, ORDERED_AT) VALUES (ORDER_SEQ.NEXTVAL, 1002, 6, 4, '20/07/10');
UPDATE ORDER_T
...
ALTER TABLE ORDER_T ADD CONSTRAINT FK_CUSTOMER_ORDER FOREIGN KEY(CUST_ID) REFERENCES CUSTOMER_T(CUST_ID) ON DELETE CASCADE;
ALTER TABLE ORDER_T ADD CONSTRAINT FK_BOOK_ORDER으로 FOREIGN KEY(BOOK_ID) REFERENCES BOOK_T(BOOK_ID) ON DELETE CASCADE;
