...
CREATE TABLE BOARD_T(
    ...
    HIT VARCHAR2(1 BYTE),
    MEM_ID VARCHAR2(30 BYTE) REFERENCES MEMBER_T(MEM_ID),
    CREATED_AD VARCHAR2(10 BYTE)
);

-- 8. 조회수 칼럼의 타입을 NUMBER로 수정하시오.
ALTER TABLE BOARD_T MODIFY TITLE NUMBER;

-- 9. 글내용 칼럼의 필수 제약조건을 제거하시오.
ALTER TABLE BOARD_T MODIFY CONTENTS NULL;
