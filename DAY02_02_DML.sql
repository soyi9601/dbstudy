...
-- 모든 컬럼리스트에 작성할거라면 생략가능함.
-- EMPLOYEE_Y 예시임

-- 사원 테이블에 행 삽입하기
INSERT INTO EMPLOYEE_T VALUES(EMPLOYEE_SEQ.NEXTVAL, '구창민', 1, '과장', 'M', '95-05-01', 50000000);
...
INSERT INTO EMPLOYEE_T VALUES(EMPLOYEE_SEQ.NEXTVAL, '한성일', 2, '과장', 'M', '93/04/01', 50000000);
-- 날짜 입력할 때 / , - 입력 가능. 디폴트 값은 /
...
-- 1. DAPARTMENT_T에서 부서번호(DEPT_NO)가 3인 부서의 지역(LOCATION)을 '인천'으로 수정하시오,
UPDATE DEPARTMENT_T
